...
public class KafkaConsumerConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, MuteUserEvent> muteUserConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(
                consumerConfigs(),
                new StringDeserializer(),
                new JsonDeserializer<>(MuteUserEvent.class)
        );
    }
    ...
    @Bean
    public ConsumerFactory<String, FollowRequestUserEvent> followRequestUserEventConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(
                consumerConfigs(),
                new StringDeserializer(),
                new JsonDeserializer<>(FollowRequestUserEvent.class)
        );
    }
